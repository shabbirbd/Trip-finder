    ...
    return (
        <div className='w-11/12 mx-auto relative flex flex-col lg:flex-row lg:items-center py-14'>
            <div className=' flex-shrink-0 mb-10 lg:mb-0 lg:mr-10 lg:w-2/5'>
                ...
                <span className='block mt-5 text-neutral-500 '>Read and share new perspectives on just about any topic. Everyone's welcome.</span>
                <ul className='space-y-4 mt-10'>
                    <li className='flex items-center space-x-4'>
                        ...
                        <span className='font-medium text-neutral-700'>Get more discounts</span>
                    </li>
                    <li className='flex items-center space-x-4'>
                        <span className='inline-flex px-2.5 py-1 rounded-full font-medium text-xs text-red-800 bg-red-100 relative'>02</span>
                        <span className='font-medium text-neutral-700'>Get premium magazines</span>
                    </li>
                </ul>
                <form className='mt-10 relative max-w-sm'>
                    <input type="email" className='block w-full border border-neutral-300 focus:border-sky-300 focus:ring focus:ring-sky-300 focus:ring-opacity-50 rounded-full text-sm font-normal h-11 px-4 py-3' required  placeholder='Enter your email'/>

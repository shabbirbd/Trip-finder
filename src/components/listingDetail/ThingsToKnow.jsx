    ...
    return (
        <div className='listingDetailCard'>
            ...
            <div>
                ...
                <div className="mt-3 text-neutral-500 max-w-md text-sm sm:text-base">
                    <div className="flex space-x-10 justify-between p-3 bg-neutral-100 dark:bg-neutral-600 dark:text-neutral-200 rounded-lg">
                        <span>Check-in</span>
                        <span>08:00 am - 12:00 am</span>
                    </div>
                    <div className="flex space-x-10 justify-between p-3 dark:text-neutral-400">
                        <span>Check-out</span>
            ...
            <div>
                ...
                <div className="p-5">
                    <ul className="mt-3 text-neutral-500 dark:text-neutral-400 space-y-2 list-disc">
